...
**产品状态：v1.2.4 已正式发布。** 当前正式合同只有 registry v3 和
...
delivery_policy:
  ...
  manager_queue_stall_timeout: 2m
  manager_queue_escalate_after: 10m
  max_manager_queue_nudges: 2
```
...
- v1.2.4 只承诺本文记录的 registry v3、event v3 与 CLI 合同；开发中的其他格式不是产品输入；
