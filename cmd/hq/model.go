...
type Event struct {
	...
	SupersedesAssignmentEventID string   `json:"supersedes_assignment_event_id,omitempty"`
	SupersedesAssignmentID      string   `json:"supersedes_assignment_id,omitempty"`
	ReplacementAssignmentID     string   `json:"replacement_assignment_id,omitempty"`
